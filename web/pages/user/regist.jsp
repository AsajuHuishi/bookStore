		...
		<div id="content">
			<div class="login_form">
				<div class="login_box">
					...
					<div class="form">
						<form action="userServlet" method="post"><!--本地表单-->
<!--								<form action="http://localhost:8080">&lt;!&ndash;本地表单&ndash;&gt;-->
							...
							<img id="code_img" alt="" src="kaptcha.jpg" style="float: right; margin-right: 40px; width: 100px; height: 20px;">
							<br />
							<br />
